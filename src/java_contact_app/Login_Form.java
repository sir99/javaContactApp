...
public class Login_Form extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jCheckBox_show.setForeground(new java.awt.Color(153, 153, 153));
        jCheckBox_show.setText("show");
    ...
    private void jButton_LoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_LoginActionPerformed
        ...
        String query = "SELECT username, password, picture, id FROM `user` WHERE `username` = ? AND `password` = ?";
        ...
        if(username.trim().equals("username")) {
            ...
            try{
                ...
                if(rs.next()) {
                    ...
                    MyContact_Form.currentUserId = rs.getInt("id");
                    System.out.println(rs.getInt("id")+"Login Form");
                    // show a new form
                    MyContact_Form form = new MyContact_Form();
                    form.setVisible(true);
                    form.pack();
                    form.setLocationRelativeTo(null);
                    form.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
                    
                    // show the user profile picture on top form
                    form.jLabelUser_pic.setIcon(new Myfunction().resizePic(null, rs.getBytes(3), form.jLabelUser_pic.getWidth(), form.jLabelUser_pic.getHeight()));
                    
                    form.jLabel_Username.setText(rs.getString(1));
